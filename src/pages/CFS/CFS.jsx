      ...
      <section className={styles.pageContent}>
        ...
        <div className={styles.CFSHero}>
          <div className={styles.CFSHeroContent}>
            <p>
              Position your brand at the forefront of cloud innovation and
              connect with 500+ industry professionals, developers, and
              decision-makers in one of India&apos;s largest AWS community
              events!
            </p>
          </div>
        </div>
        ...
        <div className={styles.CFSContent}>
          <p>
            🌐 Join us for a day of collaboration, innovation, and growth! Our
            comprehensive sponsorship packages offer unparalleled networking
            opportunities and brand exposure in the thriving cloud community.
          </p>
          <p>
            Explore our sponsorship tiers below and{" "}
            <a
              href="/Sponsorship Itenary/Sponsorship Itenary.pdf"
              style={{ color: "#ff9900", fontWeight: "600" }}
              target="_blank"
              rel="noopener noreferrer"
            >
              download the complete event brochure
            </a>{" "}
          ...
          <table className={styles["cfs-table"]}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span className={styles.highlight}>Large Display Area</span>
                </td>
                <td>
                  <span className={styles.highlight}>Medium Display Area</span>
                </td>
                <td>
                  <span className={styles.highlight}>Small Display Area</span>
                </td>
              </tr>
              <tr>
                <th className={styles["cfs-col-title"]}>
                ...
                <td>
                  <span className={styles.highlight}>30 mins (1 slot)</span>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span className={styles.highlight}>8 Sponsorship Passes</span>
                </td>
                <td>
                  <span className={styles.highlight}>5 Sponsorship Passes</span>
                </td>
                <td>
                  <span className={styles.highlight}>3 Sponsorship Passes</span>
                </td>
              </tr>
              <tr>
                <th className={styles["cfs-col-title"]}>
                ...
                <td>
                  <span className={styles.highlight}>4 times</span>
                </td>
                <td>
        ...
        <div className={styles.CFSContact}>
          <div className={styles.CFSContactContent}>
            ...
            <p>
              <a
                href="mailto:awsusergroupncr@gmail.com"
                className={styles["cfs-contact-link"]}
              >
