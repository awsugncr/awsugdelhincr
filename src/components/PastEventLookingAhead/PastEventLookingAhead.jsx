...
import styles from "./PastEventLookingAhead.module.css";

const PastEventLookingAhead = ({ eventData }) => {
  ...
  const communityData = eventData?.community || {
    meetupUrl: "https://meetup.com/your-page",
    heading: "Looking ahead",
    subheading:
      "This was only the beginning — join our community to get early access and invites for future events.",
    description:
      "Connect with fellow attendees, get event announcements, and be first to pre-register.",
  };
...
PastEventLookingAhead.propTypes = {
...
export default PastEventLookingAhead;
